...
data = {
    ...
    'values': [0.1, 0.2, 0.3],
    'type': ['progress_rate','factor_difference','factor_difference'],
    'scenario': ['doubling', 'halving', 'quadrupling'],
}
data = pd.DataFrame(data)
<<pd2org("data")>>
#+end_src
...
|   | jmp_id | country_id | year | indicator                                  | values | type              | scenario    |
|---+--------+------------+------+--------------------------------------------+--------+-------------------+-------------|
| 0 |      1 |          1 | 2002 | Sanitation Services, percent of population |    0.1 | progress_rate     | doubling    |
| 1 |      2 |          2 | 2000 | Water Services                             |    0.2 | factor_difference | halving     |
| 2 |      3 |          3 | 2000 | Water Services                             |    0.3 | factor_difference | quadrupling |
